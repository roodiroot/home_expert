...
export const testimonialsList = [
  {
    text: "“Я в восторге от работы этой компании! Они не только превратили мою старую квартиру в современное и уютное пространство, но и сделали весь процесс невероятно легким для меня. Команда была внимательна к моим пожеланиям, и результат превзошел все ожидания!”",
    name: "Михаил Д., Подмосковье",
  ...
  {
    text: "“Эта компания сделала ремонт в моей квартире, и я полностью доволен результатом. От начала до конца, вся команда проявила себя как истинные профессионалы. Особая благодарность за соблюдение сроков и бюджета.”",
    name: "Алексей С., Москва",
    date: "Квартира в новостройке",
    img: "/image/face/f3.jpg",
  },
  {
