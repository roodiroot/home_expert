      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        ...
        <div className='mt-14'>
          ...
          <p className='mt-10'>
            ...
            Оператор может получить о посетителях веб-сайта https://exemple.su.
            ...
            сетевому адресу https://exemple.su. 2.4. Информационная система
            ...
            Пользователю веб-сайта https://exemple.su. 2.9. Персональные данные,
            ...
            https://exemple.su. 2.11. Предоставление персональных данных —
            ...
            отношении обработки персональных данных. 6.1. Обработка персональных
            ...
            данных. 6.3. Не допускается объединение баз данных, содержащих
            персональные данные, обработка которых осуществляется в целях,
            несовместимых между собой. 6.4. Обработке подлежат только
            ...
            их обработки. 6.6. При обработке персональных данных обеспечивается
            ...
            если иное не предусмотрено федеральным законом. 7. Цели обработки
            персональных данных 7.1. Цель обработки персональных данных
            ...
            письмо на адрес электронной почты info@exemple.su с пометкой «Отказ
            ...
            для распространения. 8.2. Оператор обрабатывает персональные данные
            ...
            на сайте https://www.exemple.su или направленные Оператору
            ...
            электронной почты Оператора info@exemple.su с пометкой «Актуализация
            ...
            адрес Оператора info@exemple.su с пометкой «Отзыв согласия на
            ...
            почты info@exemple.su 14.2. В данном документе будут отражены любые
            ...
            Интернет по адресу https://www.exemple.su/doc/privacy.
          </p>
        </div>
      </div>
    </div>
