...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-gray-50 bg-white px-3 py-2 text-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-500 focus:outline focus:outline-2 focus:outline-accent-600  disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 ",
      className
    )}
    {...props}
  >
